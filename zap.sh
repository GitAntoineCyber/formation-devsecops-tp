...
chmod 777 $(pwd)
echo $(id -u):$(id -g)
 docker run -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-api-scan.py -t http:/devsecops69.eastus.cloudapp.azure.com:30802/v3/api-docs -f openapi -r zap_report.html
